# Quiz Name
> ### BaekJoon / [Gold4] <a href = "https://www.acmicpc.net/problem/14502"> 연구소 </a>

<br>

## 💡 approaches
>  - 브루트포스, bfs
>  - 0(벽이 없는 곳)의 좌표들을 모두 저장해놓는다.
>  - 벽을 3개 놓을 수 있는 모든 경우의 수를 확인한다.
>    - 벽을 3개를 놓는다.
>    - 안전한 구역을 카운팅한다.
>  - 위 과정에서 가장 안전한 구역의 개수를 반환한다.
...
```
### Time Complexity : O((N*M)<sup>4</sup>)
## 👩🏻‍🏫 TIL
>  -
>  -
